...
tx_fpath = fullfile(tx_fpath, 'SFI Smart Ocean Dataset', 'TX', 'wav', 'MF');
...
% Load the tx_data 
files_load = {'LFM-2000-MF.wav', 'LFM-125-MF.wav', 'LFM-25-MF.wav', 'A-PRBS-MF.wav', 'OFDM-MF.wav', 'OSDM-MF.wav', 'MFSK-MF.wav', 'JANUS-MF.wav', 'SC-QPSK-MF.wav'};
