...
tx_fpath = fullfile(tx_fpath, 'SFI Smart Ocean Dataset', 'TX', 'wav', 'HF');
...
% Load the tx_data 
files_load = {'LFM-2000-HF.wav', 'LFM-125-HF.wav', 'LFM-25-HF.wav', 'A-PRBS-HF.wav', 'OFDM-HF.wav', 'OSDM-HF.wav', 'MFSK-HF.wav', 'JANUS-HF.wav', 'SC-QPSK-HF.wav'};
